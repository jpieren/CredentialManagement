...
$AdminUserSamplehash    = Get-PasswordHash -id $AdminUserSample -Environment $Environment -EnvironmentUser $env:USERNAME -HashPath $PwdHashPath
...
$AdminUserSamplehash2    = Get-PasswordHash -id $AdminUserSample2 -Environment $Environment -EnvironmentUser $env:USERNAME -HashPath $PwdHashPath -Machine $true
